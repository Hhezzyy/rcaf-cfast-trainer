...
TEST_GUIDE_BRIEFS: dict[str, TestGuideBriefing] = {
    ...
    "numerical_operations_workout": TestGuideBriefing(
        ...
        assessment="Chained Numerical Operations workout with arithmetic priming, mixed tempo, and late pressure runs.",
        tasks=(
            "Start with warm up fact families and grouped operator runs before the core tempo blocks.",
        ...
        controls="Use Left and Right to set workout or block difficulty, and use digits plus Enter during all blocks.",
    ...
    "math_reasoning_workout": TestGuideBriefing(
        ...
        assessment="Chained Mathematics Reasoning workout with extraction and setup warm-ups, typed solve blocks, and late multiple-choice pressure work.",
        tasks=(
            "Start with train relevant-information extraction, unit and relation priming, and typed solve blocks.",
        ...
        controls="Use Left and Right to set workout or block difficulty, type answers, and use A/S/D/F/G or 1-5 then Enter during late blocks.",
        app_flow="Each block gets an untimed setup screen, and changing difficulty from workout settings restarts the workout from the beginning.",
    ),
    ...
    "airborne_numerical_workout": TestGuideBriefing(
        ...
        assessment="Chained Airborne Numerical workout with warm-up blocks, tempo calculations, and full-question scenario sets.",
        tasks=(
        ...
        controls="Use Left and Right to set workout or block difficulty, and use digits plus Enter during blocks.",
        app_flow="Each block gets an untimed setup screen, and changing difficulty from workout settings restarts the workout from the beginning.",
    ),
    ...
    "digit_recognition_workout": TestGuideBriefing(
        ...
        assessment="Chained Digit Recognition workout with visible scaffold blocks, hidden-memory family runs, and a final mixed pressure block.",
        tasks=(
        ...
        controls="Use Left and Right to set workout or block difficulty, then type digits plus Enter during all blocks.",
        app_flow="Each block gets an untimed setup screen, and changing difficulty from workout settings restarts the workout from the beginning.",
    ),
    ...
    "colours_letters_numbers_workout": TestGuideBriefing(
        ...
        assessment="Chained CLN workout with split-channel warm-ups, paired interference blocks, and late CLN overdrive blocks.",
        tasks=(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use A/S/D/F/G or mouse for memory, digits plus Enter for math, and Q/W/E for the standard colour lanes before the late overdrive variants add extra burden.",
    ...
    "angles_bearings_degrees_workout": TestGuideBriefing(
        ...
        assessment="Chained ABD workout with anchor warm-ups, typed calibration, and test-style pressure blocks.",
        tasks=(
    ...
    "visual_search_workout": TestGuideBriefing(
        ...
        assessment="Chained Visual Search workout with full-board warm-ups, family runs, mixed tempo, and late pressure.",
        tasks=(
    ...
    "instrument_comprehension_workout": TestGuideBriefing(
        ...
        assessment="Chained Instrument Comprehension workout with Part 1/2/3 warm-ups, balanced mixed runs, and late pressure.",
        tasks=(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use A/S/D/F/G or 1-5 then Enter during blocks.",
        app_flow="Each block gets an untimed setup screen, and changing difficulty from workout settings restarts the workout from the beginning.",
    ),
    ...
    "target_recognition_workout": TestGuideBriefing(
        ...
        assessment="Chained Target Recognition workout with isolated panel warm-ups, switching drills, and a final full-pressure block.",
        tasks=(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use the mouse during blocks.",
        app_flow="Each block gets an untimed setup screen, and changing difficulty from workout settings restarts the workout from the beginning.",
    ),
    ...
    "system_logic_workout": TestGuideBriefing(
        ...
        assessment="Chained System Logic workout with focused reasoning warm-ups, family switching, and a final pressure block.",
        tasks=(
    ...
    "table_reading_workout": TestGuideBriefing(
        ...
        assessment="Chained Table Reading workout with focused one-card and two-card blocks, and a final pressure run.",
        tasks=(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use Up/Down plus A/S/D/F/G or 1-5 and Enter during blocks.",
    ...
    "sma_disturbance_tempo": TestGuideBriefing(
        ...
        app_flow="This drill reuses the live Sensory Motor Apparatus screen and shows the active segment label in the header.",
    ),
    ...
    "sensory_motor_apparatus_workout": TestGuideBriefing(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use live joystick and rudder controls during blocks.",
    ...
    "auditory_capacity_workout": TestGuideBriefing(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use the normal live auditory controls during blocks.",
    ...
    "cognitive_updating_workout": TestGuideBriefing(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use the normal live Cognitive Updating controls during blocks.",
    ...
    "situational_awareness_workout": TestGuideBriefing(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use the normal live SA controls during blocks.",
    ...
    "rapid_tracking_workout": TestGuideBriefing(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use the normal live Rapid Tracking pan and capture controls during blocks.",
        app_flow="Each block gets an untimed setup screen, and every timed block reuses the live Rapid Tracking runtime with focus labels and active target or challenge metadata.",
    ),
    ...
    "spatial_integration_workout": TestGuideBriefing(
        ...
        controls="Use Left and Right to set workout or block difficulty, then use the normal Spatial Integration grid and option controls during blocks.",
