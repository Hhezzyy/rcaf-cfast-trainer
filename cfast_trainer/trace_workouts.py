...
def build_trace_test_1_workout_plan(*, duration_scale: float = 1.0) -> AntWorkoutPlan:
    ...
    blocks = (
        ...
        _block(
            "trace_orientation_decode_tempo",
            "Trace Orientation Decode Tempo",
        ...
        _block(
            "trace_orientation_decode_stress_prime",
            "Orientation Decode Stress Prime",
        ...
        _block(
            "trace_orientation_decode_extended_tempo",
            "Extended Orientation Decode",
        ...
        _block(
            "trace_orientation_decode_pressure_finish",
            "Pressure Finish",
...
def build_trace_test_2_workout_plan(*, duration_scale: float = 1.0) -> AntWorkoutPlan:
    ...
    blocks = (
        ...
        _block(
            "trace_movement_recall_tempo",
            "Trace Movement Recall Tempo",
        ...
        _block(
            "trace_movement_recall_stress_prime",
            "Movement Recall Stress Prime",
        ...
        _block(
            "trace_movement_recall_pressure_finish",
            "Pressure Finish",
