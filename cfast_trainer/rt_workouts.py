...
def build_rt_workout_plan(*, duration_scale: float = 1.0) -> AntWorkoutPlan:
    ...
    blocks = (
        ...
        _block(
            "obscured_target_prediction",
            "Obscured Target Prediction",
            "Use obscured-target passes to sharpen prediction and fast reacquisition without leaving the live capture workflow.",
        ...
        _block(
            "mixed_tempo",
            "Mixed Tempo Run",
            "Repeat the fixed six-segment cycle so lock, handoff, obscured prediction, capture, ground tempo, and air tempo all rotate under one live scene.",
