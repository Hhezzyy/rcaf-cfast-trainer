...
TEMPLATES: tuple[MapTemplate, ...] = (
    ...
    MapTemplate(
        name="T11",
        nodes=((0.10, 0.28), (0.30, 0.12), (0.50, 0.28), (0.72, 0.12), (0.88, 0.30), (0.20, 0.62), (0.48, 0.56), (0.76, 0.64)),
        edges=((0, 1), (1, 2), (2, 3), (3, 4), (0, 5), (5, 6), (6, 2), (6, 7), (7, 4), (2, 7)),
    ),
    MapTemplate(
        name="T12",
        nodes=((0.08, 0.18), (0.24, 0.38), (0.42, 0.16), (0.62, 0.36), (0.82, 0.18), (0.18, 0.70), (0.48, 0.64), (0.78, 0.68), (0.92, 0.46)),
        edges=((0, 1), (1, 2), (2, 3), (3, 4), (1, 5), (5, 6), (6, 3), (6, 7), (7, 8), (8, 4), (3, 8)),
    ),
)
